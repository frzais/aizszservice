...
async def autobot():
    ...
    if who.username:
        username = "Frizv1" + "bot"  # Ganti dengan nama yang diinginkan
    else:
        # Format: who.id + random(1-9) + "bot"
        username = "Frizv1" + str(random_digit) + "bot"  # Ganti dengan nama yang diinginkan
    bf = "@BotFather"
    ...
    if isdone.startswith("Sorry,"):
        ran = randint(1, 9)
        username = "Frizv1" + "_bot"  # Ganti dengan nama yang diinginkan
        await ultroid_bot.send_message(bf, username)
        await asyncio.sleep(1)
        isdone = (await ultroid_bot.get_messages(bf, limit=1))[0].text
